...
{/* LIVE BRACKET */}
        ...
        {!loading && tab==="draft" && (()=>{
          ...
          async function draftPick(team, fromAutoPick = false) {
            ...
            if(!isAdmin&&currentPicker){var m=owners.find(function(o){return o.user_id===authUser.id;});alert('DEBUG: authUser.id='+authUser.id+' myRec='+(m?m.num+' '+m.name:'NOT FOUND')+' currentPicker='+currentPicker.num);if(!m||m.num!==currentPicker.num){alert("It's not your turn!");return;}}
